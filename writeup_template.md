...
The predictions for each sign from the web, along with the given softmax probabilities is detailed below.
For each sign, the top 5 predictions, along with their probabilies is shown.
